...
class _SourcesScreenState extends State<SourcesScreen>
  ...
  Future<void> _toggleUserSource(String id, bool currentEnabled) async {
    setState(() {
      ...
      if (idx != -1) _userSources[idx]['enabled'] = !currentEnabled;
    });
    try {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Рейтинг доверия основан на редакционных стандартах и истории публикаций.',
  ...
  Widget _builtinCard(dynamic s, double score) {
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Row(children: [
                  Text(_trustEmoji(score), style: const TextStyle(fontSize: 18)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (s['rss_url'] != null &&
                      ...
                      const SizedBox(height: 2),
                      Row(children: [
                        Icon(Icons.rss_feed, size: 11, color: Colors.orange[400]),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.add_link, size: 36, color: Color(0xFF1A1208)),
            ),
            const SizedBox(height: 20),
